      ...
      <div className="bg-card/80 backdrop-blur-sm border border-border rounded-3xl p-6 md:p-8 space-y-8 shadow-xl">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-background/50 border border-border rounded-2xl p-4 flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-muted-foreground">GPT-4o / Claude-3.5-Sonnet (Managed by backend)</p>
            </div>
            <div className="px-3 py-1 bg-secondary text-secondary-foreground rounded-lg text-xs font-medium uppercase tracking-wider">
              System Configured
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            ...
            <a href="#" className="flex items-center gap-1 text-primary hover:underline w-fit">
...
// Minimal stub for the check icon missing above
